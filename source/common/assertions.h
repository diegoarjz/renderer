...
#define DBG_ASSERT(cond)                                                                               \
	...
	{                                                                                                  \
		if (!(cond))                                                                                   \
		{                                                                                              \
			if (::r::Fail::ReportFail(#cond, __FILE__, __LINE__, 0) == ::r::Fail::FailBehaviour::Halt) \
			{                                                                                          \
				HALT;                                                                                  \
			}                                                                                          \
		}                                                                                              \
...
#define DBG_ASSERT_MSG(cond, ...)                                                                                \
	...
	{                                                                                                            \
		if (!(cond))                                                                                             \
		{                                                                                                        \
			if (::r::Fail::ReportFail(#cond, __FILE__, __LINE__, __VA_ARGS__) == ::r::Fail::FailBehaviour::Halt) \
			{                                                                                                    \
				HALT;                                                                                            \
			}                                                                                                    \
		}                                                                                                        \
...
#define CRITICAL_ASSERT(cond)                                                                                       \
	...
	{                                                                                                               \
		if (!(cond))                                                                                                \
		{                                                                                                           \
			if (::r::Fail::ReportFail("CRITICAL! " #cond, __FILE__, __LINE__, 0) == ::r::Fail::FailBehaviour::Halt) \
			{                                                                                                       \
				HALT;                                                                                               \
			}                                                                                                       \
		}                                                                                                           \
...
#define CRITICAL_ASSERT_MSG(cond, ...)                                                        \
	...
	{                                                                                         \
		if (!(cond))                                                                          \
		{                                                                                     \
			if (::r::Fail::ReportFail("CRITICAL! " #cond, __FILE__, __LINE__, __VA_ARGS__) == \
			    ::r::Fail::FailBehaviour::Halt)                                               \
			{                                                                                 \
				HALT;                                                                         \
			}                                                                                 \
		}                                                                                     \
